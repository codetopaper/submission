...
if min_discriminator < 2:
    assert "The number of minimum well-trained discriminators should be at least 2. Please add at least one more random seed to compute LID sequences!"